...
#python training.py --dataname texas --lr 0.005 --dprate 0.4 --dropout 0.0
...
python training.py --dataname actor --lr 0.005   --dprate 0.3 --dropout 0.6   --is_bns True --act_fn prelu
